...
exports.default = {
    category: 'Moderation',
    description: 'Add, Remove and List Warns. Slash Command Specific',
    ...
    options: [
        ...
        },
        {
            type: 'SUB_COMMAND',
            name: 'list',
            description: 'Lists all warnings for a particular user',
            options: [
                {
                    name: 'user',
                    type: 'USER',
                    description: 'The user whos warnings are to be listed',
                    required: true,
                },
            ],
        },
    ...
    callback: function (_a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var subCommand, user, reason, id, warning, warning, warnings, description, _i, warnings_1, warn, embed;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, {
                                custom: true,
                                content: "Added warning " + warning.id + " to <@" + (user === null || user === void 0 ? void 0 : user.id) + ">",
                                allowedMentions: {
                                    users: [],
                                },
                            }];
                    ...
                    case 5:
                        warnings = _b.sent();
                        description = "Warnings for <@" + (user === null || user === void 0 ? void 0 : user.id) + ">:\n\n";
