...
module.exports = {
     ...
     */
     callback: async ({ Client, interaction, args }) => {
        ...
        let embed = new MessageEmbed().setColor('RANDOM').setDescription('Please choose an action.')
        ...
        collector.on('collect', async (i) => {
            if (i.customId === 'kick') {
                ...
                const embed1 = new MessageEmbed().setColor("RANDOM").setDescription(`Successfully kicked ${member.toString()} for \`${reason}\``)
                ...
                const embed2 = new MessageEmbed().setColor("RANDOM").setDescription(`Successfully banned ${member.toString()} for \`${reason}\``)
                ...
                const embed3 = new MessageEmbed().setColor("RANDOM").setDescription(`Successfully muted ${member.toString()}.`)
                ...
                const embed4 = new MessageEmbed().setColor("RANDOM").setDescription(`Successfully unmuted ${member.toString()}.`)
